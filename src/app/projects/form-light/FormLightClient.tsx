...
export default function FormLightClient() {
        ...
        <div className="relative flex min-h-screen w-full flex-col bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 transition-colors duration-300">
            <nav className="sticky top-0 z-[70] flex items-center justify-between p-4 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md border-b border-primary/10 md:hidden">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <div className="h-6 w-auto flex items-center relative">
                        <Image src="/logo-dark.png" alt="TF VISUAL" height={24} width={100} className="h-6 w-auto block dark:hidden object-contain" />
                        <Image src="/logo-light.png" alt="TF VISUAL" height={24} width={100} className="h-6 w-auto hidden dark:block object-contain" />
                    </div>
                </div>
                <ShareButton
            ...
            <main className="w-full max-w-[1600px] mx-auto">
                <div className="relative w-full aspect-[3/4] md:aspect-[21/9] overflow-hidden bg-slate-200 dark:bg-slate-800">
                    <Image
                        className="object-cover"
                        alt="Twin & Win - Collaborative portrait study by Twenty-First Visuals"
                ...
                <div className="px-6 md:px-24 lg:px-32 pb-24 space-y-12 md:space-y-24">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-start">
                        <div className="relative rounded-xl overflow-hidden bg-slate-100 dark:bg-white/5 aspect-[3/4] md:aspect-[4/5] shadow-lg">
                            <Image
                        ...
                        <div className="relative rounded-xl overflow-hidden bg-slate-100 dark:bg-white/5 aspect-[3/4] md:mt-24 shadow-lg">
                            <Image
                    ...
                    <div className="flex justify-center pt-12 md:pt-24">
                        <div className="relative w-full md:w-2/3 rounded-xl overflow-hidden bg-slate-100 dark:bg-white/5 aspect-[3/4] md:aspect-[4/5] shadow-2xl">
                            <Image
