...
export default function GalleryClient({ initialImages }: GalleryClientProps) {
    const [images] = useState<CloudinaryImage[]>(initialImages);
                        ...
                        {paginatedImages.map((img, idx) => {
                            ...
                            return (
                                ...
                                >
                                    <Image
                                        src={img.url}
                                        alt={img.title || "Photography work by Twenty-First Visuals"}
                                        fill
                    ...
                    <div className="flex-grow flex flex-col relative h-full">
                        ...
                        <main className="relative flex-grow flex items-center justify-center p-4 md:p-10 overflow-hidden h-full">
                            ...
                            <div className="relative w-full h-full flex flex-col items-center justify-center group cursor-default">
                                <div className="relative w-full h-full mt-10 mb-10">
                                    <Image
