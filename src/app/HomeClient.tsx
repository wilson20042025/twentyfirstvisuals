            ...
            <main className="flex-grow">
                        ...
                        <article className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                            ...
                            <div className="md:col-span-6">
                                <Link href="/projects/coastline" className="block">
                                    <div className="aspect-[4/5] relative overflow-hidden rounded-xl bg-background-light dark:bg-white/5 shadow-2xl group cursor-pointer transition-transform duration-500 hover:scale-[0.98]">
                                        <Image
                                            alt="The Coastline - Aerial view by Twenty-First Visuals"
                                            fill
                                            className="object-cover transition-all duration-1000 grayscale hover:grayscale-0 scale-[1.1] group-hover:scale-100"
                        ...
                        <article className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                            ...
                            <div className="md:col-span-6 order-1 md:order-2">
                                <Link href="/projects/form-light" className="block">
                                    <div className="aspect-square relative overflow-hidden rounded-xl bg-background-light dark:bg-white/5 shadow-2xl group cursor-pointer transition-transform duration-500 hover:scale-[0.98]">
                                        <Image
                                            alt="Twin & Win - Portraits by Twenty-First Visuals"
                                            fill
                        ...
                        <article className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                            ...
                            <div className="md:col-span-5">
                                <Link href="/projects/morning-mist" className="block">
                                    <div className="aspect-square relative overflow-hidden rounded-xl bg-background-light dark:bg-white/5 shadow-2xl group cursor-pointer transition-transform duration-500 hover:scale-[0.98]">
                                        <Image
                                            alt="Wallpaper Shotz - Portrait studies by Twenty-First Visuals"
                                            fill
                                            className="object-cover transition-all duration-1000 grayscale hover:grayscale-0 scale-[1.1] group-hover:scale-100"
                ...
                <section className="py-32 px-12 bg-background-light dark:bg-background-dark border-y border-slate-100 dark:border-white/10 text-center">
                    ...
                    <a
                        ...
                        href="mailto:twentyfirstvisual@gmail.com"
                    >
